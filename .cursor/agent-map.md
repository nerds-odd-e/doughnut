...
- Opt-in worktree backend tests: setup, invocation, and limits in [`docs/worktree-backend-tests.md`](../docs/worktree-backend-tests.md). From a configured checkout: `CURSOR_DEV=true nix develop -c pnpm backend:test:worktree`
