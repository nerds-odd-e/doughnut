...
description: Organize, update, and reprioritize Donut's ordered product backlog of story references across seeds. Use for backlog ordering and maintenance; story details belong in their home seeds. Do not use for LeSS in Action class backlogs (prepare-product-backlog-for-lia).
---
...
- Repository: the Donut checkout containing this skill (three directories
...
- Do not confuse this queue with the LeSS in Action class backlog produced by
  `prepare-product-backlog-for-lia`.
