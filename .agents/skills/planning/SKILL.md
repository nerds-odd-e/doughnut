...
is unresolved, `dough-story-refinement` for selected-story understanding,
`dough-slice-planning` for an executable PLAN, and `dough-slice-plan-refinement` for complex
or overrun execution leaves.
