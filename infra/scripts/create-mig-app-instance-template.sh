...
gcloud compute instance-templates create doughnut-app-zulu16-mig-template \
	...
	--metadata-from-file startup-script=${SCRIPTPATH}/mig-zulu16-app-instance-startup.sh \
