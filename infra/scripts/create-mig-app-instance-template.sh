...
gcloud compute instance-templates create doughnut-app-zulu17-mig-template \
	...
	--metadata-from-file startup-script=${SCRIPTPATH}/mig-zulu17-app-instance-startup.sh \
