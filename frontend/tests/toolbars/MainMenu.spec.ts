...
const createDefaultMenuData = (overrides = {}) => ({
  assimilationCount: {
    dueCount: 0,
...
const createDefaultRecallData = (overrides = {}) => ({
  toRepeatCount: ref(0),
...
describe("main menu", () => {
  ...
  beforeEach(() => {
    ...
    mockSdkService("getMenuData", createDefaultMenuData())
    vi.mocked(useRecallData).mockReturnValue(createDefaultRecallData())
