...
const methodToController: Record<string, any> = {
  ...
  regenerate: QuestionAnswerController,
  contest: QuestionAnswerController,
  answerQuiz: QuestionAnswerController,
  showQuestion: QuestionAnswerController,
  askAQuestion: QuestionAnswerController,
  ...
  startConversationAboutQuestionAnswer: ConversationMessageController,
