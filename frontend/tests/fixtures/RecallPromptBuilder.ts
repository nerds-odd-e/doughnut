import type { RecallPrompt, Note, PredefinedQuestion, Answer } from "@generated/backend"
...
class RecallPromptBuilder extends Builder<RecallPrompt> {
  ...
  do(): RecallPrompt {
    const predefinedQuestion = this.predefinedQuestionToUse ?? this.predefinedQuestionBuilder.do()
    return {
      id: generateId(),
