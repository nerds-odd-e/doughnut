...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="card text-white bg-danger mb-3">
            ...
            <div class="card-body">
                <p class="card-text">Look at the notes shared by other people. Search for interesting content to
                    learn. </p>
                <router-link class="btn btn-light" :to="{name: 'bazaar'}"> Visit The Bazaar </router-link>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
