...
const noteData = {
  note: {
    ...
    title: "そうだ (伝聞)",
    notePicture:
      "https://livedoor.blogimg.jp/edewakaru/imgs/d/0/d0ec0e9a-s.jpg",
    parentId: 1503,
    head: false,
      ...
      reverse: [
        ...
        },
        {
          ...
          sourceNote: {
            ...
            title: "らしい (伝聞／推測)",
            notePicture:
              "https://livedoor.blogimg.jp/edewakaru/imgs/0/a/0a362cbe-s.jpg",
            parentId: 1501,
            head: false,
            noteTypeDisplay: "Child Note",
            shortDescription:
      ...
      reverse: [
        {
          ...
          sourceNote: {
            ...
            title: "〜って/〜んだって（伝聞）",
            notePicture:
              "https://livedoor.blogimg.jp/edewakaru/imgs/6/d/6d9daff5-s.jpg",
            parentId: 2212,
            head: false,
            noteTypeDisplay: "Child Note",
            shortDescription:
      ...
      direct: [
        {
          ...
          targetNote: {
            ...
            noteTypeDisplay: "Child Note",
            shortDescription:
              "　２つの意味があります。それぞれ接続が違うので注意してください。\n\n　①伝聞\n　②様態\n　",
          },
          typeId: 2,
  ...
  ancestors: [
    ...
    },
    {
      ...
      title: "品詞",
      notePicture:
        "https://stat.ameba.jp/user_images/20200217/21/i-wataame/be/18/j/o0776136114714766926.jpg?caw=800",
      parentId: 1413,
      head: false,
      noteTypeDisplay: "Child Note",
      shortDescription: "",
  ...
  children: [
    {
      ...
      noteTypeDisplay: "Child Note",
      shortDescription:
        "［伝聞］を表す「〜そうだ」の否定形は「〜ないそうだ」「〜なかったそうだ」になりますので、気をつ...",
    },
    {
      id: 2374,
      createdAt: "2021-07-05T13:19:59.000+00:00",
    ...
    linkViewedByUser: {
      ...
      sourceNoteViewedByUser: {
        note: {
          ...
          head: false,
          shortDescription:
            "1. really (seem, appear, etc.); truly; evidentl...",
        },
        notebook: {
          id: 15,
          ownership: {
            ...
            direct: [
              {
                ...
                targetNote: {
                  ...
                  title: "丸で / まるで",
                  notePicture:
                    "https://livedoor.blogimg.jp/edewakaru/imgs/4/1/414a158c-s.jpg",
                  head: false,
                  shortDescription:
            ...
            reverse: [
              ...
              },
              {
                ...
                sourceNote: {
                  ...
                  head: false,
                  shortDescription:
                    "（1）几个，多少，几岁。多少（年头）的数量，亦指年龄。（どれぐらいの数、また、年齢。何個。何歳...",
                },
                typeId: 4,
              ...
              },
              {
                ...
                sourceNote: {
                  ...
                  title: "真逆 / まさか",
                  notePicture:
                    "https://livedoor.blogimg.jp/edewakaru/imgs/2/5/2519e5dc-s.jpg",
                  head: false,
                  shortDescription:
              ...
              },
              {
                ...
                sourceNote: {
                  ...
                  head: false,
                  shortDescription:
                    "thank you; thanks​Abbreviation, See also どうも有難う...",
                },
                typeId: 4,
              ...
              },
              {
                ...
                sourceNote: {
                  ...
                  head: false,
                  shortDescription:
                    "多少，程度如何。（どれほど。いくらぐらい。どの程度；（副詞的に用いて）程度のはなはだしいさま。...",
                },
                typeId: 4,
              ...
              },
              {
                ...
                sourceNote: {
                  ...
                  head: false,
                  shortDescription:
                    "（1）（比……）……得多de，……得很，还要……。（数量、程度にはなはだしい開きのあるさま。は...",
                },
                typeId: 4,
                createdAt: "2021-08-07T22:23:18.000+00:00",
                linkTypeLabel: "an instance of",
            ...
            reverse: [
              {
                ...
                sourceNote: {
                  ...
                  head: false,
                  shortDescription:
                    "今日、明日、昨日、明後日、一昨日、来月、先月、来年などの今が基準（発話時が基準）となって示され...",
                },
                typeId: 1,
            ...
            reverse: [
              {
                ...
                sourceNote: {
                  ...
                  head: false,
                  shortDescription:
                    "数量詞（すうりょうし、英: Quantifier）は、数量を示す単語または句をいう。数量を特定...",
                },
                typeId: 2,
      ...
      },
      {
        note: {
          ...
          noteContent: {
            ...
            title: "形容動詞",
            description:
              "形容動詞は、平安時代に形容詞が不足したとき、形容詞で表現できない意味を持つ名詞を語幹として「なり（←助詞「に」+動詞「あり」）」または「たり（←助詞「と」+動詞「あり」）」をつけることによって成立した[1]。（ナリ活用とタリ活用。前者は現在のダ型活用、後者はタルト型活用[注 1]）。\r\n\r\n独立した品詞としてこれを立てることに否定も多く、それぞれ別に節を立てて説明するが、形容詞とする立場、名詞とする立場がある。「形容動詞」という名称にも異論がある。まず、独立した品詞とする立場から説明し、その後に異論を示す。",
          ...
          head: false,
          shortDescription:
            "形容動詞は、平安時代に形容詞が不足したとき、形容詞で表現できない意味を持つ名詞を語幹として「な...",
        },
        picture: false,
        display: "形容動詞",
      },
