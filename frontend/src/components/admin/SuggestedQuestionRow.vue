<template>
  <tr>
    <td>
      {{ suggestedQuestion.preservedQuestion.f0__multipleChoicesQuestion.f0__stem }}
    </td>
...
export default {
  ...
  computed: {
    chatStarterMessage() {
      return `In the personal knowledge management system I am using, my notes are Markdown wiki pages in notebooks, linked with [[wiki links]].
      ...
      1. A multiple-choice question based on the note and its focus context, with only 1 correct answer.
