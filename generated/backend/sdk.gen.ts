...
export class NoteController {
    ...
    public static updateNoteAiAssistant<ThrowOnError extends boolean = false>(options: Options<UpdateNoteAiAssistantData, ThrowOnError>) {
        return (options.client ?? client).patch<UpdateNoteAiAssistantResponses, UpdateNoteAiAssistantErrors, ThrowOnError>({
...
export class MemoryTrackerController {
    ...
    public static reAssimilate<ThrowOnError extends boolean = false>(options: Options<ReAssimilateData, ThrowOnError>) {
        return (options.client ?? client).post<ReAssimilateResponses, ReAssimilateErrors, ThrowOnError>({ url: '/api/memory-trackers/{memoryTracker}/re-assimilate', ...options });
    }
...
export class AiController {
    ...
    public static promotePoint<ThrowOnError extends boolean = false>(options: Options<PromotePointData, ThrowOnError>) {
        return (options.client ?? client).post<PromotePointResponses, PromotePointErrors, ThrowOnError>({
    ...
    public static ignorePoints<ThrowOnError extends boolean = false>(options: Options<IgnorePointsData, ThrowOnError>) {
        return (options.client ?? client).post<IgnorePointsResponses, IgnorePointsErrors, ThrowOnError>({
