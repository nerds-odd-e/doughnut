...
export class AiController {
    ...
    public static generateSummary<ThrowOnError extends boolean = false>(options: Options<GenerateSummaryData, ThrowOnError>) {
        return (options.client ?? client).post<GenerateSummaryResponses, GenerateSummaryErrors, ThrowOnError>({ url: '/api/ai/generate-summary/{note}', ...options });
    }
