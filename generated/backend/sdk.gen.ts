...
export class RecallPromptController {
    ...
    public static askAQuestion<ThrowOnError extends boolean = false>(options: Options<AskAQuestionData, ThrowOnError>) {
        return (options.client ?? client).get<AskAQuestionResponses, AskAQuestionErrors, ThrowOnError>({ url: '/api/recall-prompts/{memoryTracker}/question', ...options });
    }
}
...
export class MemoryTrackerController {
    ...
    public static getLastAnsweredQuestion<ThrowOnError extends boolean = false>(options: Options<GetLastAnsweredQuestionData, ThrowOnError>) {
        return (options.client ?? client).get<GetLastAnsweredQuestionResponses, GetLastAnsweredQuestionErrors, ThrowOnError>({ url: '/api/memory-trackers/{memoryTracker}/last-answered-question', ...options });
    }
