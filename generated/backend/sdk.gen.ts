...
export class AiController {
    ...
    public static extractPointToChild<ThrowOnError extends boolean = false>(options: Options<ExtractPointToChildData, ThrowOnError>) {
        return (options.client ?? client).post<ExtractPointToChildResponses, ExtractPointToChildErrors, ThrowOnError>({
