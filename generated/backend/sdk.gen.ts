 ...
 * @throws ApiError
 */
export const testabilityUpdateUser = (data: TestabilityUpdateUserData): CancelablePromise<TestabilityUpdateUserResponse> => {
    return __request(OpenAPI, {
        method: 'POST',
