...
export type BareNote = {
    ...
    relationToFocusNote?: 'Self' | 'Parent' | 'Child' | 'OlderSibling' | 'YoungerSibling' | 'RelationshipTarget' | 'Relationship' | 'InboundReference' | 'SubjectOfInboundReference' | 'AncestorInContextualPath' | 'AncestorInTargetContextualPath' | 'TargetOfRelatedChild' | 'SiblingOfParent' | 'SiblingOfParentOfTarget' | 'ChildOfSiblingOfParent' | 'ChildOfSiblingOfParentOfTarget' | 'InboundReferenceContextualPath' | 'SiblingOfSubjectOfInboundReference' | 'InboundReferenceToTargetOfRelatedChild' | 'TargetSibling' | 'SubjectOfTargetSibling' | 'RemotelyRelated';
    details?: string;
