...
export type BareNote = {
    ...
    relationToFocusNote?: 'Self' | 'Parent' | 'Target' | 'Child' | 'Relationship' | 'OlderSibling' | 'YoungerSibling' | 'InboundReference' | 'SubjectOfInboundReference' | 'AncestorInContextualPath' | 'AncestorInTargetContextualPath' | 'TargetOfRelatedChild' | 'SiblingOfParent' | 'SiblingOfParentOfTarget' | 'ChildOfSiblingOfParent' | 'ChildOfSiblingOfParentOfTarget' | 'InboundReferenceContextualPath' | 'SiblingOfSubjectOfInboundReference' | 'InboundReferenceToTargetOfRelatedChild' | 'TargetSibling' | 'SubjectOfTargetSibling' | 'RemotelyRelated';
    details?: string;
