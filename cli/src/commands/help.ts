...
export const helpDoc: CommandDoc = {
  name: '/help',
  usage: '/help',
  description: 'List available commands',
}

export function formatDocRows(
...
export function createHelpSlashCommand(
  ...
  return {
    ...
    run() {
      return {
        assistantMessage: formatInteractiveHelp(getInteractiveCommandDocs()),
      }
    },
  }
}
