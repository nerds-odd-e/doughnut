...
integration behavior are outside this format decision; Accepted
[ADR 0002](./0002-git-native-portable-notebook-synchronization-accepted.md)
addresses them.
...
- Links:
  ...
  - [ADR 0002 — Git-native Portable notebook tree synchronization](./0002-git-native-portable-notebook-synchronization-accepted.md)
