...
own approval. See `.agents/skills/adr-awareness/SKILL.md`.
...
| [0005](./0005-commissioned-learning-session-protocol.md) | Proposed | Commissioned learning session protocol |
