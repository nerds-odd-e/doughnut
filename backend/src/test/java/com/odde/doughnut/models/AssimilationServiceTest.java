...
public class AssimilationServiceTest {
  ...
  void setup() {
    ...
    assimilationService =
        new AssimilationService(
            user, subscriptionService, userService, day1, ZoneId.of("Asia/Shanghai"));
  }
    ...
    class WhenTheUserSetToReview1NewNoteOnlyPerDay {
      ...
      void theDailyCountShouldNotBeResetOnSameDayDifferentHour() {
        ...
        AssimilationService recallService =
            new AssimilationService(
                user, subscriptionService, userService, day1_23, ZoneId.of("Asia/Shanghai"));
      ...
      void theDailyCountShouldBeResetOnNextDay() {
        ...
        AssimilationService recallService =
            new AssimilationService(
                user, subscriptionService, userService, day2, ZoneId.of("Asia/Shanghai"));
  ...
  class WhenReviewedMoreThanDailyLimitLastNight {
    ...
    void setup() {
      ...
      earlyMorningService =
          new AssimilationService(
              user, subscriptionService, userService, lateMorning, ZoneId.of("Asia/Shanghai"));
    }
