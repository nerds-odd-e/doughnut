...
class QuizQuestionGeneratorTest {
    ...
    void linkExclusive() {
        ...
        List<QuizQuestion.QuestionType> questionTypes = getQuestionTypes(reviewPoint);
        assertThat(questionTypes, containsInAnyOrder(LINK_TARGET, LINK_SOURCE, WHICH_SPEC_HAS_INSTANCE, FROM_SAME_PART_AS, FROM_DIFFERENT_PART_AS, DESCRIPTION_LINK_TARGET));
    }
