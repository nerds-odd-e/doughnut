...
class RestNoteControllerTests {
  ...
  class SendNoteFeedbackTests {
    ...
    void shouldStartConversation() {
      ...
      List<Conversation> conversations = (List<Conversation>) modelFactoryService.conversationRepository.findAll();
    ...
    void shouldSendFeedbackToConversation() {
      ...
      Conversation conversation = conversations.getFirst();
      List<ConversationMessage> conversationMessages = conversationService.getConversionDetailRelatedByConversationId(conversation.getId());
