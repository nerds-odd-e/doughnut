...
public class QuizQuestionBuilder extends EntityBuilder<QuizQuestion> {
    ...
    public QuizQuestionBuilder buildValid(QuizQuestion.QuestionType questionType, ReviewPoint reviewPoint) {
        QuizQuestionDirector builder = new QuizQuestionDirector(questionType, new NonRandomizer(), reviewPoint, makeMe.modelFactoryService);
        this.entity = builder.buildQuizQuestion();
        return this;
    }
