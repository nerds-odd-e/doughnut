...
class NotebookGitJdbcObjectStoreTest {
  ...
  void roundTripsThroughCloseReopenAppendAndExport() throws Exception {
    ...
    List<PortableTreeEntry> v1 =
        List.of(
            new PortableTreeEntry("Parent/README.md", "Parent readme"),
            new PortableTreeEntry("Parent/Child/Note.md", "First body"));
    List<PortableTreeEntry> v2 =
        List.of(
            new PortableTreeEntry("Parent/README.md", "Parent readme"),
            new PortableTreeEntry("Parent/Child/Note.md", "Second body"));
    List<PortableTreeEntry> v3 =
        List.of(
            new PortableTreeEntry("Parent/README.md", "Parent readme"),
            new PortableTreeEntry("Parent/Child/Note.md", "Second body"),
            new PortableTreeEntry("Parent/Added.md", "New note"));
    ...
    try (Connection reopenConnection = jdbcFixture.openConnection();
      ...
      List<PortableTreeEntry> v4 =
          List.of(
              new PortableTreeEntry("Parent/README.md", "Parent readme"),
              new PortableTreeEntry("Parent/Child/Note.md", "Third body"),
              new PortableTreeEntry("Parent/Added.md", "New note"));
      ObjectId commit4 =
          NotebookGitBundleBuilder.append(
              reopened,
  ...
  void abortedTransactionLeavesNoTornStateVisibleFromAnotherConnectionOrAReopenedInstance()
    ...
    List<PortableTreeEntry> v1 = List.of(new PortableTreeEntry("Note.md", "Committed body"));
    List<PortableTreeEntry> v2 = List.of(new PortableTreeEntry("Note.md", "Aborted body"));
  ...
  void oneAppendAcrossManyTreesIssuesOneBatchedExistenceCheckQuery() throws Exception {
    ...
    List<PortableTreeEntry> baseEntries =
        List.of(
            new PortableTreeEntry("A/B/C/Leaf.md", "before"),
            new PortableTreeEntry("A/B/Sibling.md", "unchanged"),
            new PortableTreeEntry("A/Other/Note.md", "unchanged"),
            new PortableTreeEntry("Top.md", "unchanged"));
    List<PortableTreeEntry> changedEntries =
        List.of(
            new PortableTreeEntry("A/B/C/Leaf.md", "after"),
            new PortableTreeEntry("A/B/Sibling.md", "unchanged"),
            new PortableTreeEntry("A/Other/Note.md", "unchanged"),
            new PortableTreeEntry("Top.md", "unchanged"));
