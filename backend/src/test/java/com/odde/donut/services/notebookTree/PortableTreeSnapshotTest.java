...
class PortableTreeSnapshotTest {
    ...
    List<PortableTreeEntry> entries =
        PortableTreeSnapshot.build(
            ...
            List.of(
                ...
                new PortableTreeAttachmentRow(null, "empty.bin", new byte[0]),
                new PortableTreeAttachmentRow(null, "agents.json", "{\"a\": 1}".getBytes(UTF_8))));
  ...
  @Test
  void buildsOrderedEntriesForNestedFoldersAndNotes() {
