...
public class WikiLinkResolver {
   ...
   * (looked up by ID, excluding trashed notes, with the same viewer-readability check applied to
   * note-ID URL targets elsewhere, e.g. {@code NoteReferenceService}) against {@code sourceNote}'s
   * scope and {@code viewer}'s current readability.
   */
