...
public class Link {
    ...
    public enum LinkType {
        RELATED_TO                            (1, "related note", "is related to", "is not related to", new QuestionType[]{WHICH_SPEC_HAS_INSTANCE}),
        ...
        USES                                  (15, "user", "uses", "does not use", new QuestionType[]{LINK_TARGET, LINK_SOURCE_EXCLUSIVE, WHICH_SPEC_HAS_INSTANCE, WHICH_SPEC_HAS_INSTANCE}),
