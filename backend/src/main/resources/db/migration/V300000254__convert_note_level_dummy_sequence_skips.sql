-- Convert live note-level dummy sequence skips (UNDERSTANDING, removed from
-- tracking, recall_count = 0, empty property_key) into assimilation_sequence_skip
-- rows and soft-delete those trackers.
--
-- No-op everywhere by default (`spring.flyway.placeholders.dummy_note_sequence_skip_convert=1=0`).
...
WHERE ${dummy_note_sequence_skip_convert}
