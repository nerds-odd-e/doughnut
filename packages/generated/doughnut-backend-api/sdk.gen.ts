...
export class NotebookBooksController {
    ...
    /**
     * Split a book block into two
     */
    public static splitBookBlock<ThrowOnError extends boolean = false>(options: Options<SplitBookBlockData, ThrowOnError>) {
        return (options.client ?? client).post<SplitBookBlockResponses, unknown, ThrowOnError>({ url: '/api/notebooks/{notebook}/book/blocks/{bookBlock}/split', ...options });
    }
