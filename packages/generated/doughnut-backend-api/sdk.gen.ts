...
export class NoteController {
    ...
    public static showNoteByAmbiguousBasename<ThrowOnError extends boolean = false>(options: Options<ShowNoteByAmbiguousBasenameData, ThrowOnError>) {
        return (options.client ?? client).get<ShowNoteByAmbiguousBasenameResponses, unknown, ThrowOnError>({ url: '/api/notes/by-basename/{basename}', ...options });
    }
}
