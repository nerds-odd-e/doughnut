...
export class NoteController {
    ...
    public static showNoteByBasename<ThrowOnError extends boolean = false>(options: Options<ShowNoteByBasenameData, ThrowOnError>) {
        return (options.client ?? client).get<ShowNoteByBasenameResponses, unknown, ThrowOnError>({ url: '/api/notes/by-basename/{basename}', ...options });
    }
}
...
export class WikiSlugMigrationAdminController {
    public static batchMigrateNotes<ThrowOnError extends boolean = false>(options?: Options<BatchMigrateNotesData, ThrowOnError>) {
        return (options?.client ?? client).post<BatchMigrateNotesResponses, unknown, ThrowOnError>({ url: '/api/admin/wiki-slug-migration/batch/notes', ...options });
    }
    
    public static batchMigrateFolders<ThrowOnError extends boolean = false>(options?: Options<BatchMigrateFoldersData, ThrowOnError>) {
        return (options?.client ?? client).post<BatchMigrateFoldersResponses, unknown, ThrowOnError>({ url: '/api/admin/wiki-slug-migration/batch/folders', ...options });
    }
    
    public static getStatus<ThrowOnError extends boolean = false>(options?: Options<GetStatusData, ThrowOnError>) {
        return (options?.client ?? client).get<GetStatusResponses, unknown, ThrowOnError>({ url: '/api/admin/wiki-slug-migration', ...options });
    }
}
