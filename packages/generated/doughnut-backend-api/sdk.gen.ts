...
export class NotebookController {
    ...
    /**
     * List folder scope: notes in folder and direct child folders
     *
     * Notes are those assigned to the folder. Folders are immediate children of the given folder.
     */
    public static listFolderListing<ThrowOnError extends boolean = false>(options: Options<ListFolderListingData, ThrowOnError>) {
        return (options.client ?? client).get<ListFolderListingResponses, unknown, ThrowOnError>({ url: '/api/notebooks/{notebook}/folders/{folder}/listing', ...options });
    }
