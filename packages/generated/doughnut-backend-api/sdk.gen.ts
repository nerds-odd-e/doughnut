...
export class NoteController {
    ...
    public static reorder<ThrowOnError extends boolean = false>(options: Options<ReorderData, ThrowOnError>) {
        return (options.client ?? client).post<ReorderResponses, unknown, ThrowOnError>({
