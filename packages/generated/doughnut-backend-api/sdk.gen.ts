...
export class AdminDataMigrationController {
    /**
     * Run wiki index-folder data migration
     */
    public static runDataMigration<ThrowOnError extends boolean = false>(options?: Options<RunDataMigrationData, ThrowOnError>) {
        return (options?.client ?? client).post<RunDataMigrationResponses, unknown, ThrowOnError>({ url: '/api/admin/data-migration/run', ...options });
    }
