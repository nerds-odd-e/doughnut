...
export class NotebookBooksController {
    ...
    public static listBooks<ThrowOnError extends boolean = false>(options: Options<ListBooksData, ThrowOnError>) {
        return (options.client ?? client).get<ListBooksResponses, unknown, ThrowOnError>({ url: '/api/notebooks/{notebook}/books', ...options });
    }
    
    public static getBook<ThrowOnError extends boolean = false>(options: Options<GetBookData, ThrowOnError>) {
        return (options.client ?? client).get<GetBookResponses, unknown, ThrowOnError>({ url: '/api/notebooks/{notebook}/books/{book}', ...options });
    }
}
