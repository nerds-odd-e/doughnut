...
export class NotebookBooksController {
    /**
     * Mark book range as read for the current user
     */
    public static putNotebookBookRangeReadingRecord<ThrowOnError extends boolean = false>(options: Options<PutNotebookBookRangeReadingRecordData, ThrowOnError>) {
        return (options.client ?? client).put<PutNotebookBookRangeReadingRecordResponses, unknown, ThrowOnError>({ url: '/api/notebooks/{notebook}/book/ranges/{bookRange}/reading-record', ...options });
    }
