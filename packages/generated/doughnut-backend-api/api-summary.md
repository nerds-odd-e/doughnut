...
- `deleteQuestions`: DELETE `/api/predefined-questions/{note}/note-questions/delete` -> `DeleteQuestionsResponse` (request: `DeleteQuestionsData`; path: note; body: Array<number>; response body: void)
