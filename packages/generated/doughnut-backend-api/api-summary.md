...
- `updateQuestion`: PATCH `/api/predefined-questions/{predefinedQuestion}` -> `UpdateQuestionResponse` (request: `UpdateQuestionData`; path: predefinedQuestion; body: PredefinedQuestion; response body: PredefinedQuestion)
