...
- `markAsRecalled`: PATCH `/api/memory-trackers/{memoryTracker}/mark-as-recalled` -> `MarkAsRecalledResponse` (request: `MarkAsRecalledData`; path: memoryTracker; query: grade; response body: MemoryTracker)
