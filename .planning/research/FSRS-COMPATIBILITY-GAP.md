...
**Status:** Interval fuzz is **closed** (not used; due follows S). Remaining knob: **E4** fitting, plus **accept ADR 0003** (human). Shipped FSRS-6 locks live in ADR 0003 Decision and code.
