...
- A no-change pull creates no irrelevant differences for version-control tools.
...
### 5. Preview local edits and conflicts before pushing
...
### 6. Push edits to existing notes safely
...
### 7. Create a Doughnut note from a local Markdown file
...
### 8. Rename a note through its local filename
...
- The operation is recoverable through Doughnut's trash.
