...
- [x] 08-02-PLAN.md — CLI `/export` E2E proofs for three Story 1 gaps + phase wrap-up
...
- [x] 09-01-PLAN.md — Strengthen previewPull taxonomy + diagnostics (create/update/move/reject) + units
- [x] 09-02-PLAN.md — CLI `/sync --dry-run` E2E: action labels, rejects, non-mutation
...
- [x] 10-01-PLAN.md — Strengthen applyPull (create/update/move + gated baseline) + units + cli_sync_pull E2E
...
- [x] 12-01-PLAN.md — Strengthen `/push --dry-run` (load-only baseline + create/update + units + cli_push_dry_run E2E)
