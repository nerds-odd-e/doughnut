...
- Critical env/system properties: `OPENAI_API_TOKEN`, `MYSQL_PASSWORD`, `OAUTH2_github_client_id` / `OAUTH2_github_client_secret`, `GITHUB_FOR_ISSUES_API_TOKEN`, `DOUGHNUT_SPA_PUBLIC_BASE_URL`, `DONUT_API_BASE_URL`, `DONUT_API_AUTH_TOKEN`
