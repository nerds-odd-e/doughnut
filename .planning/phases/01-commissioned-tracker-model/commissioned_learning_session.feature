...
Feature: Commissioned learning session
  As a learner, I want Doughnut to commission a tutor to conduct a learning session
  for my due commissioned notes, and to record the tutor's report,
  so that my memory trackers advance from what the tutor observed.
