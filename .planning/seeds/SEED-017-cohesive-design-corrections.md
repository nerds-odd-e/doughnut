...
- **Broader folder-subtree composition:** destination scope remains
  unresolved. Folder identity and its existing exact-subtree semantics remain a
  distinct domain responsibility, not an excuse for duplicated ordinary-note
  detectors.
