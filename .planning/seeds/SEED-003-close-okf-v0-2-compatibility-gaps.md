...
2. Remaining codec work: **P9**, YAML path-valued `source`/`target`, collision basenames (identity is folder path + title, not `Recipe (2).md`). Tracker: [OKF-COMPATIBILITY-GAP.md](../research/OKF-COMPATIBILITY-GAP.md).
