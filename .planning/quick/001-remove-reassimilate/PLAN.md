...
| Orphan soft-deleted trackers | Not migrated — `V300000245` reverted; rows inert under unique index | See [MILESTONES](../../MILESTONES.md) (2026-08-12) |
...
`V300000245` shipped here; **reverted** 2026-08-12 — caused production outage (FK block). See [MILESTONES](../../MILESTONES.md) (2026-08-12). Orphan rows remain; inert under partial unique index.
