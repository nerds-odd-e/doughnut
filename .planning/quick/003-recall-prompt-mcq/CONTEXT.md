...
**Status:** executing (slices 1–7 done)  
...
| MCQ | `predefined_question` | `PredefinedQuestion`; `/api/predefined-questions`; answered JSON **`mcq`** | E2E MCQ wording (filenames leftover) |
