...
- [ ] Quick plan (outside milestone): `.planning/quick/260724-db-timezone-fix/` — Phase 1 done (JDBC URLs pinned to UTC, live in prod). Root cause revised after prod forensics: real skewed window is ~2025-06 to ~2026-06 (13 months, not the originally-planned 1-month window around 6/20); trigger still unknown. Phases 2-4 superseded pending developer decision — see plan's Status log.
