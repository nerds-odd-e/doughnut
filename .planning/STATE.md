...
- [ ] Quick plan (outside milestone): `.planning/quick/260724-db-timezone-fix/` — pin JDBC session tz to UTC + repair +8h-skewed prod TIMESTAMPs (2026-06-20 → fix rollout); Phase 1 done (JDBC URLs pinned to UTC), Phases 2-4 planned.
