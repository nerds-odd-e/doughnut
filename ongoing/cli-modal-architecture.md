...
- **Ordering:** Phases A–D deliver a safe **extract-and-thin-adapter** path even if Ink is deferred; E–I require the **decision gates** to be closed. **Next:** Ink shell is complete through Phase I; further work is product-driven (decision gates) or small cleanups.
