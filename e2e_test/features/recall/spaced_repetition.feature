...
Feature: Spaced-repetition
  ...
  Scenario: Strictly follow the schedule
    ...
    And On day 4 I recall "Note 1, Note 3, end " and assimilate new "end         "
    And On day 5 I recall "Note 2, end         " and assimilate new "end         "
    And On day 6 I recall "Note 3, end         " and assimilate new "end         "
    And On day 7 I recall "                    " and assimilate new "end         "
