Feature: Summary Generation
    As a learner, I want to have a summary of my note generated by AI
    when I start assimilating a note.
    So that I can confirm that I understand all the key points of the note.
