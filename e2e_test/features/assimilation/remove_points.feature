...
Background:
  ...
  Scenario: Remove points from note when assimilating
    ...
    #   | It is the main language of international business, science, technology, and diplomacy |
    #   | English provides strong advantages for careers and academic pursuits |
    #   | The majority of digital and online content is available in English |
    #   | Proficiency in English facilitates international travel and access to global media |
