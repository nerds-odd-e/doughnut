...
Feature: CLI access token
  As a learner, I want to save a Doughnut Access Token in the interactive CLI so authenticated commands work.
  ...
  Scenario: Saved access token allows recall status
    ...
    And I save the Doughnut Access Token in the interactive CLI
