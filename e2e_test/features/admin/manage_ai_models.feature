...
Feature: Manage AI models
  ...
  Background:
    ...
    And OpenAI creates an assistant of ID "new_assistant" for name "Noteboot assistant" with model "gpt-future"
  ...
  Scenario: Admin choose a default model and use it for creating assistants
    ...
    Then I recreate all the assitants and the new assistant ID should be "new_assistant" for "Noteboot assistant"
